...
"""
PyInstaller Spec File for Internet Radio Player
Bu dosya PyInstaller tarafından EXE oluşturmak için kullanılır
"""
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=True,  # DEBUG için console aç (geçici)
